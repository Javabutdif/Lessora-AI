  ...
  return [
    ...
    JSON.stringify({
      ...
      blocks: [
        ...
        {
          type: "section",
          title: "AI Transparency Note",
          instructions: [
            "Include the exact text: 'This lesson plan was generated by AI based on the provided inputs, selected lesson plan template, educational best practices, and curriculum-aligned instructional design. Teachers are encouraged to review, adapt, and supplement the content with official curriculum documents, textbooks, and school-approved resources.'"
          ]
        }
      ],
      exportTargets: ["doc"],
