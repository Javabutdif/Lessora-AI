...
export default function PreviewPage() {
  ...
  async function handleExport(format: "pdf" | "docx") {
    ...
    try {
      ...
      const headerHtml = `<div style="font-family: Arial, sans-serif; max-width: 800px; margin: 0 auto; padding: 40px;"><h1 style="font-size: 24px; color: #1e3a5f; border-bottom: 2px solid #2F5BFF; padding-bottom: 12px; margin-bottom: 24px;">${doc.title}</h1><p style="color: #64748b; font-size: 13px; margin-bottom: 24px;">Subject: ${plan.subject} | Grade: ${plan.gradeLevel} | Duration: ${plan.totalDuration} min</p>`;
      const footerHtml = `<p style="font-size: 11px; color: #94a3b8; margin-top: 40px; border-top: 1px solid #e2e8f0; padding-top: 16px;">Generated by Lessora AI</p></div>`;
